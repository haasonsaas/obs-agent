...
from .exceptions import (
    ...
    SceneNotFoundError, SourceNotFoundError, ValidationError,
    handle_obs_error
)
from .validation import (
    validate_scene_name, validate_source_name, validate_port,
    validate_host, validate_file_path, validate_settings
)
...
__all__ = [
    ...
    'OBSAgent', 'OBSController', 'AdvancedOBSAgent', 'AdvancedOBSController',
    
    # New improved classes
    'OBSAgentV2', 'create_obs_agent',
    
    # Configuration
    'Config', 'OBSConfig', 'StreamingConfig', 'LoggingConfig',
    'get_config', 'set_config',
    
    # Connection management
    'ConnectionManager', 'get_connection_manager', 'obs_connection',
